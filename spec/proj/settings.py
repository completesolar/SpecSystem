...
CSRF_TRUSTED_ORIGINS = ['http://localhost:8084', 'http://127.0.0.1:8084', 'http://127.0.0.1:8084',  'http://127.0.0.1:8000', 'http://spec-dev01:80/', 'http://0.0.0.0:8084', 'http://localhost:8087']
